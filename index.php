...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="publico/css/adminlte.css">
</head>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="?modulo=cliente&acao=listar" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="?modulo=produto&acao=listar" class="nav-link">
                            <i class="nav-icon far fa-circle text-info"></i>
                            <p>Produto</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="?modulo=produto&acao=adicionar" class="nav-link">
                            <i class="nav-icon far fa-circle text-info"></i>
